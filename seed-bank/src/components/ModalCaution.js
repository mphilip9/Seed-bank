            ...
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-emerald-700 outline-none focus:outline-none">
                <p className="text-white p-2">
                  This app is in beta and only has data for zones 3-8. We would
                  like to account for all zones in the lower 48 states. If you
                  know where we can find data to get planting dates by hardiness
                  zones please let us know! Check the about page for contact
                  info.{" "}
                </p>
