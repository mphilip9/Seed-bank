      ...
      <div className="flex flex-row justify-between ">
        <div className="flex flex-row pl-3">
          <select
            ...
            className="hover:cursor-pointer w-60 border-black md:p-2.5 text-black bg-white border rounded-full shadow-sm outline-none appearance-none focus:border-indigo-600 "
          >
          ...
          <div className="pl-2 pt-3">
            Choose a month to see what you can plant
          </div>
        </div>
        <div className="md:pr-3">
          {currentPlants.length > 0 ? (
            <button
              className="align-self-end dark:bg-black bg-forest hover:bg-blue-700 text-white font-bold md:py-2 md:px-4 rounded-full w-15"
              onClick={() => print()}
            >
              Download PDF
            </button>
